...
* Need be answered $\implies$ can **quantified with a number**
...
<table>
  ...
  <tr>
      <td><img src="figs/qanda.jpeg" alt="3" width = 120px height = 120px></td>
...
url <- "https://polimdo.ac.id/wp-content/uploads/2022/03/kisspng-lecture-clip-art-5ada0a0e3d7959.1665428415242388622518.png"
knitr::include_graphics(url)
```
...
* **If you did not complete the class in 2022**:
  * Can roll over ALL assignment grades and only sit the exam
    * Email the course email address by XX if you want this applied 
...
If you are already on our Canvas site, **please fill out THIS form** 
